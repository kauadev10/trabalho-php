...
$numero = 10; // Coloque o numero que deseja verificar se é positivo, negativo ou zero
echo is_numeric($numero)
    ? (($numero > 0) ? "$numero é positivo" : (($numero < 0) ? "$numero é negativo" : "$numero é zero")) : "Valor inválido: informe um número.";
